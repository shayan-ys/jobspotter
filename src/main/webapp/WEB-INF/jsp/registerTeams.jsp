...
<!DOCTYPE html>
    ...
    <div class="content">
      <div class="container">
        ...
        <div class="row">
          <form action="registerTeams" method="post" class="form-horizontal register" id="pwd-container">
            ...
            <div class="form-group">
              <label for="company" class="col-sm-2 control-label">نام تیم</label>
              <div class="col-sm-10">
                <input name="name" type="text" class="form-control" id="company" placeholder="نام تیم">
              </div>
            </div>
            <div class="form-group">
