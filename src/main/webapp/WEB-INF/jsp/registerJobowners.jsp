...
<jsp:include page="header.jsp" />
  <div class="content">
      <div class="container">
        ...
        <div class="row">
          <form class="form-horizontal register" id="pwd-container">
            <div class="form-group">
              <label for="username" class="col-sm-2 control-label">ایمیل</label>
              <div class="col-sm-10">
                <input type="email" class="form-control" id="username" placeholder="ایمیل">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <div class="form-inline province-cities">
                  ...
                  <div class="form-group pull-left">
                    ...
                    <select id="cities" class="city form-control"></select>
                  </div>
                </div>
              </div>
            </div>
            <div class="form-group">
              <label for="company" class="col-sm-2 control-label">نام شرکت</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="company" placeholder="نام شرکت">
              </div>
            </div>
            <div class="form-group">
              <label for="category" class="col-sm-2 control-label">زمینه فعالیت</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" id="category" placeholder="زمینه فعالیت">
              </div>
            </div>
            <div class="form-group">
